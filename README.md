...
> [!WARNING]
> Le projet doit être consulté via la [démo en ligne](https://lohkinap.github.io/NWE2U-582-D24-RI-TP2/) ou via un serveur local (tel que [vscode-live-server](https://github.com/ritwickdey/vscode-live-server)) pour assurer le bon fonctionnement des scripts.
...
- **Démo :** Accessible via [GitHub Pages](https://lohkinap.github.io/NWE2U-582-D24-RI-TP2/).
